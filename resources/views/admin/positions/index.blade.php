                ...
                <tbody>
                    @forelse($positions as $position)
                        <tr>
                            ...
                            {{-- File EN --}}
                            <td class="text-center">
                                <a href="{{ route('admin.content.edit', ['model' => 'positions', 'id' => $position->id, 'lang' => 'en']) }}"
                                ...
                                @if($position->file_url_en)
                                    <a href="{{ route('admin.content.download', ['model' => 'positions', 'id' => $position->id, 'lang' => 'en']) }}"
                            ...
                            {{-- File ES --}}
                            <td class="text-center">
                                <a href="{{ route('admin.content.edit', ['model' => 'positions', 'id' => $position->id, 'lang' => 'es']) }}"
                                ...
                                @if($position->file_url_es)
                                    <a href="{{ route('admin.content.download', ['model' => 'positions', 'id' => $position->id, 'lang' => 'es']) }}"
