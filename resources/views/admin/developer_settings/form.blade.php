        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('developer-settings.update') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="stripe_product_id" class="form-control" placeholder="prod_..."
                        value="{{ old('stripe_product_id', $setting->stripe_product_id) }}">
                </div>

                <div class="mb-3">
                    <label class="form-label">Stripe Currency</label>
                    <input type="text" name="stripe_currency" class="form-control" placeholder="usd"
                        value="{{ old('stripe_currency', $setting->stripe_currency) }}">
                </div>
                <div class="mt-2">
                    <button type="button" class="btn btn-outline-danger btn-sm" onclick="testStripeConnection()">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="paypal_live_client_id" class="form-control" placeholder="AXXXXXXXXXXXXX"
                        value="{{ old('paypal_live_client_id', $setting->paypal_live_client_id) }}">
                </div>

                <div class="mb-3">
                    <label class="form-label">PayPal Client Secret</label>
                    <input type="password" name="paypal_live_client_secret" class="form-control" placeholder="••••••••">
                    <small class="text-muted">
                        Leave blank to keep the current secret.
                    </small>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="paypal_live_currency" class="form-control" placeholder="usd"
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="recaptcha_secret_key" class="form-control" placeholder="••••••••">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="analytics_property_id" class="form-control" placeholder="G-XXXXXXXXXX"
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('developer-settings.index') }}" class="btn btn-secondary">
